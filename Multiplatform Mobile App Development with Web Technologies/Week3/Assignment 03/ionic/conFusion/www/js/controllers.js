...
.controller('MenuController', ['$scope', 'menu', 'favoriteFactory', 'baseURL', '$ionicListDelegate', function($scope, menu, favoriteFactory, baseURL, $ionicListDelegate) {
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover', '$ionicModal', function($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal) {
  ...
  $scope.submitComment = function() {
    ...
    $scope.form.dishcomment.$setPristine();
    $scope.modal.hide();
    $scope.popover.hide();
...
.controller('IndexController', ['$scope', 'menu', 'promotion', 'corporate', 'baseURL', function($scope, menu, promotion, corporate, baseURL) {
